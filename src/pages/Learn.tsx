...
const MODULE_ICONS: Record<string, { emoji: string; color: string }> = {
  Math: { emoji: "🔢", color: "from-blue-500 to-blue-400" },
  Science: { emoji: "🔬", color: "from-green-500 to-green-400" },
  Reading: { emoji: "📚", color: "from-purple-500 to-purple-400" },
  Art: { emoji: "🎨", color: "from-pink-500 to-pink-400" }
};
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {modules.map((m) => {
              const moduleConfig = MODULE_ICONS[m] || { emoji: "📝", color: "from-gray-500 to-gray-400" };
              return (
                <button
                  key={m}
                ...
                >
                  <span className="text-8xl mb-6 transform group-hover:scale-110 transition-transform duration-300 emoji">
                    {moduleConfig.emoji}
                  </span>
